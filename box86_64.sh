...
BOX86_DEB=https://github.com/mikamito998/android-linux/raw/main/resources/box86-android_0.3.3.deb
BOX64_DEB=https://github.com/mikamito998/android-linux/raw/main/resources/box64-android_0.2.5.deb
# Stable Wine =
...
sudo apt update
sudo apt upgrade -y
sudo apt install -y xz-utils gpg software-properties-common --no-install-recommends --no-install-suggests
